...
\begin{frame}
    ...
    \begin{columns}[T,onlytextwidth]
        \begin{column}{.5\textwidth}
            ...
            \begin{minipage}{\textwidth}
                \begin{itemize}
                    \item<2-> is the project I'm contributing to.
                    \item<3-> is managed by Dr. Carette \& Dr. Smith.
                    \item<4-> originates from the work of Dan Szymczak.
                        \begin{itemize}
                            \item<5-> Originally focused on scientific software (\emph{Literate Scientific Software}).
                            \item<6-> Focus expanded...
                        \end{itemize}
                    \item<7-> tries to ``Generate All The Things''...
                    \begin{itemize}
                        \item<8-> with a focus on research software.
                    \end{itemize}
                    \item<9-> has a website\footnotemark[1]!
                \end{itemize}
            \end{minipage}
        \end{column}
...
\begin{frame}
    ...
    \onslide<5->{Generating view-only data (e.g., SRS documents) is considerably easier than generating working code.}
...
%% - Catches, within reason, all possible scenarios where an expression goes awry. Dependent types would be a nice addition, but, alas.
