...
\begin{frame}
    ...
    \begin{itemize}
        ...
        \item<3-> As of writing, current case studies include:
            ...
            \end{itemize}
    \end{itemize}
    %% TODO: Link to Drasil website examples list
\end{frame}
...
\begin{frame}
    ...
    \begin{figure}
        ...
        \caption{Knowledge flow from ``knowledge-base''/source code to artifacts, by Dr. Spencer Smith}
        \label{fig:glassbr}
    \end{figure}
\end{frame}
...
%% TODO: ``RelationConcept''s don't contain enough information on their own to be a core component usable in code generation.
%% TODO: Problem? Why focus on this?
%% TODO: What is a good ``solution''?
%% TODO: Current project status?
